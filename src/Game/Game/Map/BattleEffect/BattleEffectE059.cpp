...
BattleEffectE059::~BattleEffectE059()
{

}

void BattleEffectE059::Update()
{
	effectTimer++;
	if (effectTimer == 1)
	{
		for (auto& pos : attackPositionList)
		{
			...
			{
				playerMap->CauseByEnemy(enemyStatus, direction, sourceID, 59);
			}
		}
	}
	if (effectTimer == 30)
