...
BattleEffectE065::~BattleEffectE065()
{

}

void BattleEffectE065::Update()
{
	effectTimer++;
	if (effectTimer == 1)
	{
		for (auto& pos : attackPositionList)
		{
			...
			{
				playerMap->CauseByEnemy(enemyStatus, direction, sourceID, 65);
			}
		}
	}
	if (effectTimer == 30)
