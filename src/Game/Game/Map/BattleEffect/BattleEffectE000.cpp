...
BattleEffectE000::~BattleEffectE000()
{

}

void BattleEffectE000::Update()
{
	effectTimer++;
	if (effectTimer == 1)
	{
		...
		{
			playerMap->CauseByEnemy(enemyStatus,direction, sourceID, 0);
		}
	}
	if (effectTimer == 30)
	{
