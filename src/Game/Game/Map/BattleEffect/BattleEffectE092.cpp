...
void BattleEffectE092::Update()
{
	...
	if (effectTimer == 1)
	{
		...
		{
			playerMap->CauseByBoss(bossStatus, direction, sourceID, 92);
		}
	}
	if (effectTimer == 24)
	{
