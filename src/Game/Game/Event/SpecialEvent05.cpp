...
SpecialEvent05::SpecialEvent05()
{
	playerDirection = Direction::DOWN;
	playerPosition = Vector2<int>(32 * 12 + Define::MASU_SIZE / 2, 32 * 5 + Define::MASU_SIZE / 2);
	playerMoveTime = 0;
...
void SpecialEvent05::UpdateEvent()
{
	...
	if (eventTimer == 128)
	{
		...
		windowList.push_back(make_shared<MessageWindow>("‘ºl", "ŠR•ö‚ê‚É‚Â‚«‚±‚Ìæ‚Íˆê“I‚É—§‚¿“ü‚è‹Ö~‚Æ‚È‚Á‚Ä‚¨‚è‚Ü‚·B"));
	}
	if (160 < eventTimer)
	{
		darkAlpha += 5;
...
void SpecialEvent05::Draw()
{
	Vector2<int> offset = Vector2<int>(50, 100);
